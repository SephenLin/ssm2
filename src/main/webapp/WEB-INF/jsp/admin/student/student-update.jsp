...
<article class="page-container">
    <form action="${pageContext.request.contextPath }/admin/student-update.action" method="post" class="form form-horizontal" id="form-member-add">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>姓名：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${student.contact_name}" placeholder="" id="contact_name" name="contact_name">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>学号：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${student.contact_subject}" placeholder="" id="contact_subject" name="contact_subject">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>手机：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${student.contact_phone}" placeholder="" id="contact_phone" name="contact_phone">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>专业：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${student.contact_major}" placeholder="" id="contact_major" name="contact_major">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>邮箱：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${student.contact_email}" placeholder="@" name="contact_email" id="contact_email">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">部门：</label>
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select class="select" size="1" name="contact_department">
                        <option value=".Net部" <c:if test='${student.contact_department eq ".Net部"}'>selected="selected"</c:if>>.Net部</option>
                        <option value="Java部" <c:if test='${student.contact_department eq "Java部"}'>selected="selected"</c:if>>Java部</option>
                        <option value="美工部" <c:if test='${student.contact_department eq "美工部"}'>selected="selected"</c:if>>美工部</option>
                        <option value="行政部" <c:if test='${student.contact_department eq "行政部"}'>selected="selected"</c:if>>行政部</option>
                        <option value="php小组" <c:if test='${student.contact_department eq "php小组"}'>selected="selected"</c:if>>php小组</option>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="contact_message" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" onKeyUp="$.Huitextarealength(this,100)">${student.contact_message}</textarea>
