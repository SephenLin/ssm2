<%--
  ...
  Date: 2017/7/7
  Time: 16:08
 allegorieshis template use File | Settings | File Templates.
--%>
    ...
    <table class="table table-border table-bordered table-bg">
        ...
        <c:forEach items="${admins}" var="admin">
            <tr class="text-c">
                ...
                <td>${admin.id}</td>
                <td><u style="cursor:pointer" class="text-primary" onclick="admin_show('${admin.name}的个人信息','${pageContext.request.contextPath }/admin/admin-show.action','${admin.id}','360','400')">${admin.name}</u></td>
                <td>${admin.account}</td>
                <td>${admin.sex}</td>
                <td>${admin.email}</td>
                <td>${admin.photoNumber}</td>
                <td>${admin.department}</td>
                <td class="td-status"><span class="label label-success radius">已启用</span></td>
                <td class="td-manage"><a style="text-decoration:none" onClick="admin_stop(this,'10001')" href="javascript:;" title="停用"><i class="Hui-iconfont">&#xe631;</i></a> <a title="编辑" href="javascript:;" onclick="admin_edit('管理员编辑','${pageContext.request.contextPath }/admin/admin-add.action','1','800','500')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> <a title="删除" href="javascript:;" onclick="admin_del(this,'1')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
